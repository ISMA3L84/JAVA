...
import ActividadPropuesta9_2.ColaDoble;

public class Lista implements Pila, ColaDoble{//Se declaran las dos.
    //..atributos y metodos ya implementados anteriormente,.
    Integer[] tabla;
    private int i;
    ...
    public Integer desapilar() {//se extrae el último elemento.
       return eliminar(tabla.length -1); // null si pila está vacía.
    }
    @Override
    public void pistacho(Integer nuevo) {
        insertarFinal(nuevo);
    }
}    
