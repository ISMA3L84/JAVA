...
public class Lista {
     ...
     */
     ...
     public String toString(){
        ...
        String cadena = "";
        //cadena = cadena + "Lista: " + tabla + "\n";
      
        cadena = cadena + "El numero de elementos de la lista es: : " + getnumeroElementos() + "\n";
        cadena = cadena + "Busqueda de elemento: " + buscar(2) + "\n";
        cadena = cadena + "Indice de la tabla: " + get(4) + "\n";
